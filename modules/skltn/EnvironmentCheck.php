...
class EnvironmentCheck{
    ...
    public function throwNotifications(){
        ...
        foreach ($results['errors'] as $err){
            // styling
            echo '<div class="notice notice-error cryptex-notice"><p><strong>Cryptex Plugin Error: </strong>', $err, '</p></div>';
        }

        // show warnings
        foreach ($results['warnings'] as $err){
            // styling
            echo '<div class="notice notice-warning cryptex-notice"><p><strong>Cryptex Plugin Warning: </strong>', $err, '</p></div>';
        }
    }
