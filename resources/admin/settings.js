...
jQuery(document).ready(function(jq){
    ...
    if (typeof storage === 'object'){
        ...
        var recentSelectedTabID = storage.getItem('cryptex-tabnav');
        ...
        jq('#cryptex-tabnav a').each(function (){
            ...
            el.click(function () {
                ...
                // store current tab
                try{
                    storage.setItem('cryptex-tabnav', currentTab.attr('data-tab'));
    ...
    if (typeof jQuery.fn.ColorPicker === 'function'){
        ...
        jq('.cryptex-colorpicker').ColorPicker({
        ...
        // initialize colors
        jq('.cryptex-colorpicker').each(function(){
            // get current element
            var el = jq(this);
