...
jQuery(document).ready(function(){
    ...
    var lastActiveTab = Cookies.get('cryptex-tabnav');

    // container actions
    var currentTab = (lastActiveTab ? jQuery("#cryptex-tabnav a[data-tab='" + lastActiveTab + "']") : jQuery('#cryptex-tabnav a:first-child'));
    jQuery('#cryptex-tabnav a').each(function () {
        // get current element
        var el = jQuery(this);
        ...
        el.click(function () {
            ...
            Cookies.set('cryptex-tabnav', currentTab.attr('data-tab'), {expires: 1});
        });
    });
    ...
    // show navbar
    jQuery('#cryptex-tabnav').show();


    // Selective Sections 
    // --------------------------------------------------------
    jQuery('.cryptex-selective-section').each(function(){
        // get current element
